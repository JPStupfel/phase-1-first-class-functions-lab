...
function createFareMultiplier(num){return (fair)=> fair * num}
...
const fareDoubler = function(fair) {return createFareMultiplier(2)(fair)}
...
const fareTripler = function(fair) {return createFareMultiplier(3)(fair)}
...
const selectDifferentDrivers = function(array,fnc) {return fnc(array)}
